...
class ProfileScreen extends StatelessWidget {
  ...
  Widget _buildInfoTile({
    ...
    final double iconSize = isCenter ? 34.0 : 24.0;
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(icon, color: const Color(0xFF135BEC), size: iconSize),
          const SizedBox(width: 16),
          if (isCenter)
            SizedBox(
              width: 200, // 고정 너비를 주어서 두 타일의 아이콘 위치가 세로로 완벽히 정렬되도록 함
              child: Column(
